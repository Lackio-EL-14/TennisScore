...
describe("Tennis Score", () => {
    ...
    it ("Deberia mostrar Adventage Player 1 cuando el jugador 1 anota un punto despues de Deuce", () => {
        const scorer = new TennisScorer();
        scorer.player1Scores();
        scorer.player1Scores();
        scorer.player1Scores();
        ...
        scorer.player2Scores();
        scorer.player1Scores();
        expect(scorer.showScore()).toEqual("Adventage Player 1");
    });
    it ("Deberia mostrar Adventage Player 2 cuando el jugador 2 anota un punto despues de Deuce", () => {
        const scorer = new TennisScorer();
        scorer.player1Scores();
        scorer.player1Scores();
        scorer.player1Scores();
    ...
    it ("Deberia mostrar Game for Player 2 cuando el jugador 2 anota un punto despues de Adventage Player 2", () => {
        const scorer = new TennisScorer();
        scorer.player1Scores();
        scorer.player1Scores();
        scorer.player1Scores();
